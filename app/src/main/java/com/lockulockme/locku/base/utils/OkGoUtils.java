...
public class OkGoUtils {
    ...
    public <T> void postObject(String url, Object tag, Object o, NewJsonCallback<T> callback) {
    ...
    public <T> void postFile(String url, Object tag, String fileName, File file, NewJsonCallback<T> callback) {
        url = UriConstant.getBaseUrl() + url;
        LockUOkGo.getInstance().postFile(tag,url,file,null,fileName,callback);
    }


    public void reportUser(Object tag, ReportRequestBean req, File file, NewJsonCallback callback) {
    ...
    public void getData() {
        postObject("", "", new BaseEntity(), new NewJsonCallback<BaseEntity>() {
    ...
    public void onRegister(Object tag, RegisterRequestBean registerReq, NewJsonCallback<LoginResponseBean> callback) {
        postObject(UriConstant.ONE_CLICK_REGISTER, tag, registerReq, callback);
    }

    public void setPassword(Object tag, SetPwbRequest setPwbRequest, NewJsonCallback<Void> callback) {
        postObject(UriConstant.SET_PWB, tag, setPwbRequest, callback);
    }


    public void onLogin(Object tag, LoginRequestBean loginReq, NewJsonCallback<LoginResponseBean> callback) {
        postObject(UriConstant.LOGIN_ACCOUNT, tag, loginReq, callback);
    }

    public void linkFacebook(Object tag, FacebookRequestBean facebookRequestBean, NewJsonCallback<Void> callback) {
        postObject(UriConstant.BIND_FACEBOOK, tag, facebookRequestBean, callback);
    }

    public void linkGoogle(Object tag, GoogleSignRequest googleSignRequest, NewJsonCallback<Void> callback) {
        postObject(UriConstant.BIND_GOOGLE, tag, googleSignRequest, callback);
    }


    public void completeInfo(Object tag, CompleteInfoRequest completeInfoRequest, NewJsonCallback<Void> callback) {
        postObject(UriConstant.COMPLETE_INFO, tag, completeInfoRequest, callback);
    }

    public void getIndexList(Object tag, IndexRequestBean indexReq, NewJsonCallback<List<IndexUserResponseBean>> callback) {
        postObject(UriConstant.INDEX_LIST, tag, indexReq, callback);
    }

    public void getRankList(Object tag, PageRequestBean pageReq, int type, NewJsonCallback<List<RankItemResponseBean>> callback) {
    ...
    public void getOtherInfo(Object tag, SheDetailsRequestBean req, NewJsonCallback<UserInfo> callback) {
        postObject(UriConstant.SHE_INFO, tag, req, callback);
    }

    public void getSheImages(Object tag, SheImageRequestBean req, NewJsonCallback<List<SheImageResponseBean>> callback) {
        postObject(UriConstant.OTHER_IMAGES, tag, req, callback);
    }

    public void getSheVideos(Object tag, SheImageRequestBean req, NewJsonCallback<List<SheVideoResponseBean>> callback) {
        postObject(UriConstant.OTHER_VIDEOS, tag, req, callback);
    }

    public void getShePrices(Object tag, VideoPriceRequestBean req, NewJsonCallback<List<AudioAndVideoPriceResponseBean>> callback) {
        postObject(UriConstant.VOICE_VIDEO_CHAT_PRICE, tag, req, callback);
    }

    public void userSayHello(Object tag, SheDetailsRequestBean req, NewJsonCallback<SayHelloResponseBean> callback) {
        postObject(UriConstant.SAY_HELLO, tag, req, callback);
    }

    public void getVipState(Object tag, NewJsonCallback<VipResponseBean> callback) {
        postObject(UriConstant.VIP_STATE, tag, new Object(), callback);
    }

    public void promptBind(Object tab, NewJsonCallback<Boolean> callback) {
        postObject(UriConstant.PROMPT_BIND, tab, new Object(), callback);
    }

    public void getRetentionInfo(Object tag,NewJsonCallback<RetentionBean> callback){
        postObject(UriConstant.RETENTION_INFO,tag,new Object(),callback);
    }

    public void getMyDetail(Object tag, NewJsonCallback<UserInfo> callback) {
        postObject(UriConstant.MY_DETAILS, tag, new Object(), callback);
    }

    public void unbind(Object tag, UnbindRequest unbindRequest, NewJsonCallback<Void> callback) {
        postObject(UriConstant.UNBIND, tag, unbindRequest, callback);
    }

    public void getMyStone(Object tag, NewJsonCallback<MyStoneResponseBean> callback) {
        postObject(UriConstant.MY_STONE_NUM, tag, new Object(), callback);
//        postObject(UriConstant.VIP_STATE, tag, new Object(), callback);
    }

    public void getCountry(Object tag, NewJsonCallback<List<CountryResponseBean>> callback) {
        postObject(UriConstant.COUNTRY_LIST, tag, new Object(), callback);
    }



    public void modifyPersonalInfo(Object tag, UserInfo req, NewJsonCallback<Void> callback) {
        postObject(UriConstant.MODIFY_MY_INFO, tag, req, callback);
    }

    public void uploadPortrait(Object tag, String filename, File file, NewJsonCallback<UploadPortraitResponseBean> callback) {
        postFile(UriConstant.UPLOAD_PORTRAIT, tag, filename, file, callback);
    }


    public void uploadAlbums(Object tag, String filename, File file, NewJsonCallback<Void> callback) {
        postFile(UriConstant.UPLOAD_ALBUMS, tag, filename, file, callback);
    }

    public void getProductList(Object tag, ProductRequestBean productReq, NewJsonCallback<List<ProductResponseBean>> callback) {
        postObject(UriConstant.PRODUCT_LIST, tag, productReq, callback);
    }

    public void getPayCenterList(Object tag, Object object, NewJsonCallback<List<PayCenterResponseBean>> callback) {
        postObject(UriConstant.PAY_CENTER_LIST, tag, object, callback);
    }

    public void createPayOrder(Object tag, Object object, NewJsonCallback<CreatePayOrderResponseBean> callback) {
        postObject(UriConstant.CREATE_PAY_ORDER, tag, object, callback);
    }

    public void updatePayOrder(Object tag, Object object, NewJsonCallback<UpdatePayOrderResponseBean> callback) {
        postObject(UriConstant.UPDATE_GOOGLE_ORDER, tag, object, callback);
    }

    public void getMyAlbums(Object tag, Object object, NewJsonCallback<List<MyAlbumResponseBean>> callback) {
        postObject(UriConstant.ALBUM_LIST, tag, object, callback);
    }

    public void getCodaPayUrl(Object tag, Object object, NewJsonCallback<String> callback) {
        postObject(UriConstant.INDIA_CODA, tag, object, callback);
    }

    public void getPayerMaxUrl(Object tag, Object object, NewJsonCallback<String> callback) {
        postObject(UriConstant.PAYER_MAX_URL, tag, object, callback);
    }

    public void getPayUrlV2(Object tag, Object object, NewJsonCallback<GetUrlV2ResponseBean> callback) {
        postObject(UriConstant.GET_PAY_URL, tag, object, callback);
    }

    public void getLookmeList(Object tag, Object object, NewJsonCallback<List<LookMeResponseBean>> callback) {
        postObject(UriConstant.LOOK_ME_LIST, tag, object, callback);
    }

    public void deleteImage(Object tag, Object object, NewJsonCallback<Void> callback) {
        postObject(UriConstant.DELETE_IMAGE, tag, object, callback);
    }

    public void modifyPassword(Object tag, Object object, NewJsonCallback<Void> callback) {
        postObject(UriConstant.MODIFY_PASSWORD, tag, object, callback);
    }

    public void getUnreadMsg(Object tag, NewJsonCallback<Integer> callback) {
        postObject(UriConstant.GET_UNREAD_MSG, tag, new Object(), callback);
    }

    public void getMyLevel(Object tag, NewJsonCallback<MyLevelRe> callback) {
        postObject(UriConstant.GET_MY_LEVEL, tag, new Object(), callback);
    }

    public void getNotificationMsg(Object tag, Object obj, NewJsonCallback<SystemMsgResponseBean> callback) {
        postObject(UriConstant.NOTIFICATION_MSG, tag, obj, callback);
    }

    public void isEnough(Object tag, Object obj, NewJsonCallback<EnoughResponseBean> callback) {
        postObject(UriConstant.ENOUGH, tag, obj, callback);
    }

    public void getVideoList(Object tag, Object obj, NewJsonCallback<List<VideoResponseBean>> callback) {
    ...
    public void getMacyList(Object tag, Object object, NewJsonCallback<List<SheMacyResponseBean>> callback) {
        postObject(UriConstant.MACY_LIST, tag, object, callback);
    }

    public void getSheGiftList(Object tag, Object object, NewJsonCallback<SheGiftsResponseBean> callback) {
        postObject(UriConstant.SHE_GIFT_LIST, tag, object, callback);
    }

    public void blockUser(Object tag, Object object, NewJsonCallback<Void> callback) {
        postObject(UriConstant.BLOCK_USER, tag, object, callback);
    }

    public void noLikeVideo(Object tag, Object object, NewJsonCallback<Void> callback) {
    ...
    public void facebookLogin(Object tag, Object object, NewJsonCallback<LoginResponseBean> callback) {
        postObject(UriConstant.FACEBOOK_LOGIN, tag, object, callback);
    }

    public void googleLogin(Object tag, GoogleSignRequest googleSignRequest, NewJsonCallback<LoginResponseBean> callback) {
        postObject(UriConstant.GOOGLE_LOGIN, tag, googleSignRequest, callback);
    }

    public void getBind(Object tag, NewJsonCallback<List<BindData>> callback) {
    ...
    public void getVipImages(Object tag, Object object, NewJsonCallback<List<VipBannerImageResponseBean>> callback) {
    ...
    public void attention(Object tag, AttentionRequestBean requestBean, NewJsonCallback<Void> callback) {
        postObject(UriConstant.ATTENTION, tag, requestBean, callback);
    }

    public void unAttention(Object tag, AttentionRequestBean requestBean, NewJsonCallback<Void> callback) {
        postObject(UriConstant.UN_ATTENTION, tag, requestBean, callback);
    }

    public void getAttentionNum(Object tag, NewJsonCallback<AttentionNumResponseBean> callback) {
        postObject(UriConstant.ATTENTION_NUM, tag, new Object(), callback);
    }

    public void getAttentionList(Object tag, AttentionListRequestBean requestBean, NewJsonCallback<List<UserInfo>> callback) {
        postObject(UriConstant.ATTENTION_LIST, tag, requestBean, callback);
    }

    public void getRateTags(Object tag, RatingTagRequestBean requestBean, NewJsonCallback<List<RateTagResponseBean>> callback) {
        postObject(UriConstant.RATE_TAG, tag, requestBean, callback);
    }

    public void ratingUser(Object tag, RatingUserRequestBean requestBean, NewJsonCallback<Void> callback) {
        postObject(UriConstant.RATE_USER, tag, requestBean, callback);
    }

    public void getUserTags(Object tag, SheTagRequestBean requestBean, NewJsonCallback<SheTagResponseBean> callback) {
    ...
    public void getInterceptLabel(Object tag, VipInterceptRequestBean requestBean, NewJsonCallback<VipInterceptResponseBean> callback) {
        postObject(UriConstant.INTERCEPT_LABEL, tag, requestBean, callback);
    }

    public void getFirstGuideDialog(Object tag, NewJsonCallback<FirstGuideResponseBean> callback) {
