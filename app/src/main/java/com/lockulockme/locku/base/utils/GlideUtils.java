...
import com.lockulockme.locku.module.custom.GlideCircleTransform;
import com.lockulockme.locku.module.custom.GlideRoundTransform;
...
public class GlideUtils {
     ...
     * @param placeHolder
     */
    public static void loadImage(FragmentActivity context, String path, ImageView imageView, int placeHolder) {
        if (TextUtils.isEmpty(path)) {
            imageView.setImageResource(placeHolder);
        } else {
            RequestOptions options = new RequestOptions();
    ...
    public static void loadImage(Fragment fragment, String path, ImageView imageView, int placeHolder) {
        if (TextUtils.isEmpty(path)) {
            imageView.setImageResource(placeHolder);
        } else {
            RequestOptions options = new RequestOptions();
...
//
    ...
    public static void loadCircleImg(Fragment fragment, String path, ImageView imageView) {
        if (TextUtils.isEmpty(path)) {
            imageView.setImageResource(R.mipmap.normal_placeholder);
        } else {
            if (fragment != null) {
    ...
    public static void loadCircleImg(Context context, String path, ImageView imageView, int resId) {
        if (TextUtils.isEmpty(path)) {
            ...
            if (context != null) {
                ...
                options.circleCrop();
                Glide.with(context).load(path)
                        .apply(options).placeholder(resId).error(resId)
                        .into(imageView);
            }
        }
    }
    ...
    public static void loadCircleImg(Fragment fragment, String path, ImageView imageView, int resId) {
        if (TextUtils.isEmpty(path)) {
            imageView.setImageResource(resId);
        } else {
            if (fragment != null) {
...
//        }
//    }
    public static void loadImageSimpleTarget(Context context, String url) {
        RequestOptions options = new RequestOptions();
        options.diskCacheStrategy(DiskCacheStrategy.DATA);
        Glide.with(context)
                .asFile()
