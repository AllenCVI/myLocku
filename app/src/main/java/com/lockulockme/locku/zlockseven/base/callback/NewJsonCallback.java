package com.lockulockme.locku.zlockseven.base.callback;
...
import com.lockulockme.locku.zlockseven.application.MyApplication;
import com.lockulockme.locku.zlockseven.base.utils.AccountManager;
import com.lockulockme.locku.zlockseven.common.LoginoutManager;
import com.lockulockme.locku.zlockseven.common.ParameterizedTypeImpl;
...
public abstract class NewJsonCallback<T>{
    ...
    public  void onSuc(T response, String msg){}
