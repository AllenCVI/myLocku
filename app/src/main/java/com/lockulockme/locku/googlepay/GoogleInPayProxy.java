...
public class GoogleInPayProxy {
    ...
    public void buyGoodsByGoogleInApp(String orderId, String goodId) {
        ...
        for (int i = 0; i < skuDetailList.size(); i++) {
            ...
            if (goodId.equals(localSkuDetail.getSku())) {
        ...
        googleInAppClient.purchaseInApp(activity, skuDetail, orderId);
    }
