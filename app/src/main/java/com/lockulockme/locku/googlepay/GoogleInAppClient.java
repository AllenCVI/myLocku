...
public class GoogleInAppClient {
    ...
    public void purchaseInApp(Activity activity, SkuDetails skuDetails, String orderId) {
        purchase(activity, skuDetails, orderId);
    }


    private void purchase(Activity activity, final SkuDetails skuDetails, String orderId) {
        if (mBillingClient == null) {
        ...
        if (connectBillingService()) {
            BillingFlowParams flowParams = BillingFlowParams.newBuilder()
                    ...
                    .build();
            ReportUtils.report("GooglePayUtils", "onPurchase", ReportConstant.ORDER_ID_PAY_BEFORE, "orderId:" + orderId);
