...
import com.lockulockme.locku.zlockeight.module.ui.adapter.CountryAdapter;
...
public class HomeFragment extends BaseFragment<FgHomeBinding> {
    ...
    private void loadCountry() {
        showLoading();
        OkGoUtils.getInstance().getCountry(this, new NewJsonCallback<List<CountryResponseBean>>() {
            @Override
