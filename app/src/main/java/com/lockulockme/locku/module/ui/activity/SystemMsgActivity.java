...
import com.lockulockme.locku.module.ui.adapter.SystemMsgAdapter;
...
public class SystemMsgActivity extends BaseActivity<AcSystemNotificationBinding> {
    ...
    private void getNotificationMsg(int pg, int sz) {
        showLoading();
        OkGoUtils.getInstance().getNotificationMsg(SystemMsgActivity.this, new SystemMsgRequestBean(pg, sz), new NewJsonCallback<SystemMsgResponseBean>() {
            @Override
