...
import com.lockulockme.locku.module.ui.adapter.HotAdapter;
...
public class HotFragment extends BaseFragment<FgHotBinding> {
    ...
    private String countryStr = AccountManager.getInstance().getCurrentUser().country;
    ...
    public void updateCountryStr(String str) {
        ...
        if (binding.refreshLayout.isRefreshing() || binding.refreshLayout.isLoading() || binding.refreshLayout.getState() == RefreshState.LoadFinish || binding.refreshLayout.getState() == RefreshState.RefreshFinish) {
            page = 1;
...
//    }
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putString("country", countryStr);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            countryStr = savedInstanceState.getString("country");
            if (binding != null && binding.refreshLayout != null) {
                binding.refreshLayout.autoRefresh();
            }
        }
    ...
    private void loadIndexData(int pg, int limit, String country, int type) {
        VipManager.getInstance().getVipState(this, new VipManager.OnVipListener() {
            @Override
            public void onVipSuccess(VipResponseBean vipResp) {
                OkGoUtils.getInstance().getIndexList(HotFragment.this, new IndexRequestBean(pg, limit, country), new NewJsonCallback<List<IndexUserResponseBean>>() {
                    @Override
