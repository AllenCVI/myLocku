...
import com.lockulockme.locku.module.ui.adapter.SeeMeAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seeMeAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(@NonNull BaseQuickAdapter<?, ?> adapter, @NonNull View view, int position) {
                VipManager.getInstance().getVipState(SeeMeActivity.this, new VipManager.OnVipListener() {
                    @Override
    ...
    private void loadData() {
        ...
        VipManager.getInstance().getVipState(SeeMeActivity.this, new VipManager.OnVipListener() {
            ...
            public void onVipSuccess(VipResponseBean vipResp) {
                ...
                OkGoUtils.getInstance().getLookmeList(SeeMeActivity.this, new Object(), new NewJsonCallback<List<LookMeResponseBean>>() {
                    @Override
