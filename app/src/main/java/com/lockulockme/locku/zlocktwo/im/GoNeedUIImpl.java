package com.lockulockme.locku.zlocktwo.im;
...
import com.lockulockme.locku.module.ui.activity.RatingActivity;
import com.lockulockme.locku.zlocktwo.common.PopupWindowBuilder;
import com.lockulockme.locku.zlocktwo.module.ui.activity.CurrentDiamondActivity;
import com.lockulockme.locku.zlocktwo.module.ui.activity.ReportActivity;
import com.lockulockme.locku.zlocktwo.module.ui.activity.SheDetailActivity;
import com.lockulockme.locku.zlocktwo.module.ui.activity.VipGoodsListActivity;
import com.lockulockme.locku.zlocktwo.module.ui.pop.CommentAppPop;
...
public class GoNeedUIImpl implements GoNeedUI {
    ...
    public void goRating(Activity activity, int type, String imId) {
        RatingActivity.start(activity, imId, type);
    }
}
