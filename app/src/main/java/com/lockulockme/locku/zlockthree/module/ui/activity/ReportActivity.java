...
import com.lockulockme.locku.zlockthree.module.ui.adapter.ReportAdapter;
...
public class ReportActivity extends BaseActivity<AcReportBinding> {
    ...
    private void reportUser(String content) {
        showLoading();
        OkGoUtils.getInstance().reportUser(this, new ReportRequestBean(userStringId, content, String.valueOf(position), String.valueOf(checkType())), file, new NewJsonCallback<Void>() {
            @Override
