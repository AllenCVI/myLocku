package com.lockulockme.locku.zlockthree.module.ui.fragment;
...
import com.lockulockme.locku.zlockthree.base.utils.GlideUtils;
...
import com.lockulockme.locku.zlockthree.common.BaseFragment;
import com.lockulockme.locku.zlockthree.module.ui.activity.CurrentDiamondActivity;
import com.lockulockme.locku.zlockthree.module.ui.activity.MainActivity;
import com.lockulockme.locku.zlockthree.module.ui.activity.ModifyActivity;
import com.lockulockme.locku.zlockthree.module.ui.activity.MySpaceActivity;
import com.lockulockme.locku.zlockthree.module.ui.activity.SeeMeActivity;
import com.lockulockme.locku.zlockthree.module.ui.activity.SettingsActivity;
import com.lockulockme.locku.zlockthree.module.ui.activity.SystemMsgActivity;
import com.lockulockme.locku.zlockthree.module.ui.activity.UploadAvatarActivity;
import com.lockulockme.locku.zlockthree.module.ui.activity.VipGoodsListActivity;
...
//    UserInfo userBean = AccountManager.getInstance().getCurrentUser();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        OkGoUtils.getInstance().getMyDetail(this, new NewJsonCallback<UserInfo>() {
            @Override
            public void onSuc(UserInfo response, String msg) {
                ...
                if ("1".equals(response.userGender)) {
                    GlideUtils.loadCircleImg(getContext(), response.avatar, binding.ivMyPortrait, R.mipmap.ic_male_portrait_placeholder);
                } else {
                    GlideUtils.loadCircleImg(getContext(), response.avatar, binding.ivMyPortrait, R.mipmap.ic_female_portrait_placeholder);
                }
            }
    ...
    private void getUnreadMsg() {
        OkGoUtils.getInstance().getUnreadMsg(this, new NewJsonCallback<Integer>() {
            @Override
